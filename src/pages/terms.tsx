    ...
    <div className="min-h-screen bg-bg py-16 px-6">
      ...
      <div className="max-w-3xl mx-auto bg-surface border-2 border-border p-8 sm:p-12 shadow-sm font-sans">
        ...
        <div className="prose prose-sm max-w-none space-y-6 text-text/80 leading-relaxed">
          <section>
            <h2 className="text-sm font-bold uppercase tracking-widest text-text border-l-4 border-linkedin-blue pl-3 mb-3">Agreement to Terms</h2>
          ...
          <section>
            <h2 className="text-sm font-bold uppercase tracking-widest text-text border-l-4 border-linkedin-blue pl-3 mb-3">Service Fees & Payment</h2>
          ...
          <section>
            <h2 className="text-sm font-bold uppercase tracking-widest text-text border-l-4 border-linkedin-blue pl-3 mb-3">Production Specifications</h2>
          ...
          <section>
            <h2 className="text-sm font-bold uppercase tracking-widest text-text border-l-4 border-linkedin-blue pl-3 mb-3">Limitation of Liability</h2>
